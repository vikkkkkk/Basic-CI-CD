...
do
      ...
      do
        ...
        then
          ...
          TEST4="-e for -e ^int s21_grep.c $var $var3"
          echo "$TEST4"
          ...
          TEST5="-e regex -e ^print s21_grep.c $var $var3 -f patterns"
          echo "$TEST5"
          ...
          TEST6="-e while -e void s21_grep.c Makefile $var $var3 -f patterns"
          echo "$TEST6"
